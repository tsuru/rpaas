...
class ConsulManagerTestCase(unittest.TestCase):
    ...
    def test_remove_node(self):
        ...
        self.consul.kv.put("test-suite-rpaas/myrpaas/ssl/test-server/cert", "cert")
        self.consul.kv.put("test-suite-rpaas/myrpaas/ssl/test-server-2/cert", "cert")
        ...
        item = self.consul.kv.get("test-suite-rpaas/myrpaas/status/test-server")
        self.assertIsNone(item[1])
        item = self.consul.kv.get("test-suite-rpaas/myrpaas/ssl/test-server/cert")
        self.assertIsNone(item[1])
        item = self.consul.kv.get("test-suite-rpaas/myrpaas/ssl/test-server-2/cert")
